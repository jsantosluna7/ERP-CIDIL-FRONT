...
import { faClock, faArrowRightFromBracket, faBell, faCartShopping, faChartSimple, faDesktop, faGreaterThan, faHeart, faHouse, faMagnifyingGlass, faMicrochip, faShop, faUser } from '@fortawesome/free-solid-svg-icons';
