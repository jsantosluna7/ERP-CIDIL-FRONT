...
   * Prioriza el nombre corto de usuario y luego el nombre completo.
   */
    ...
    try {
      ...
      if (storedUser) {
        ...
        if (storedUser.nombre) {
          return storedUser.nombre.split(' ')[0]; // Opcional: solo devuelve el primer nombre si tienes el nombre completo
        }
      }
