...
export const routes: Routes = [
   {
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'calendario',loadComponent: () =>import( './components/home/dashboard/all-widget/calendario/calendario.component').then((m) => m.CalendarioComponent),canActivate: [RoleGuard],data: { roles: [1, 3, 4] },},
            {
                path: 'usuarios',
