...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      { path: '', loadComponent: () => import('./components/home/redireccion/redireccion.component').then(m => m.RedireccionComponent) },
      {
        path: 'dashboard',
        loadComponent: () =>
      ...
      },
      {
        path: 'calendario',
        loadComponent: () =>
          import('./components/home/dashboard/all-widget/calendario/calendario.component').then(
